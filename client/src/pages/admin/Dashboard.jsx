...
const Dashboard = () => {
  ...
  { title: "Total Users", value: dashboardData.totalUsers || "5", icon: UsersIcon }
  ]
...
<div className='relative flex flex-wrap gap-4 mt-6'>
  ...
  <div className='flex flex-wrap gap-4 w-full'>
    {dashboardCards.map((card,index)=>(
      <div key={index} className='flex items-center justify-between px-3 py-4 bg-primary/10 border
